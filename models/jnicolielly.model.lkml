...
datagroup: jnicolielly_default_datagroup {
...
explore: billion_orders {
  ...
  join: users {
    type: left_outer
    sql_on: ${orders.user_id} = ${users.id_id_id_id_id_id_id_id_id_id_id_id_id_id_id_id_id_id_id} ;;
    relationship: many_to_one
  }
}
...
explore: demo_visits_data {
  join: users {
    type: left_outer
    sql_on: ${demo_visits_data.user_id} = ${users.id_id_id_id_id_id_id_id_id_id_id_id_id_id_id_id_id_id_id} ;;
    relationship: many_to_one
  }
}
...
explore: events {
  join: users {
    type: left_outer
    sql_on: ${events.user_id} = ${users.id_id_id_id_id_id_id_id_id_id_id_id_id_id_id_id_id_id_id} ;;
    relationship: many_to_one
  }
}
...
explore: saralooker {
  join: users {
    type: left_outer
    sql_on: ${saralooker.user_id} = ${users.id_id_id_id_id_id_id_id_id_id_id_id_id_id_id_id_id_id_id} ;;
    relationship: many_to_one
  }
}
...
explore: sindhu {
  join: users {
    type: left_outer
    sql_on: ${sindhu.user_id} = ${users.id_id_id_id_id_id_id_id_id_id_id_id_id_id_id_id_id_id_id} ;;
    relationship: many_to_one
  }
}
...
explore: user_data {
  join: users {
    type: left_outer
    sql_on: ${user_data.user_id} = ${users.id_id_id_id_id_id_id_id_id_id_id_id_id_id_id_id_id_id_id} ;;
    relationship: many_to_one
  }
}
